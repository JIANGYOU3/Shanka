...
```bash
python3 "/mnt/c/Users/admin/.codex/skills/ui-ux-pro-max/scripts/search.py" "<query>" --domain <domain>
```
...
### Native Android guardrails

For Android projects, treat database results as candidates rather than requirements:

- Always query `--stack jetpack-compose` and prefer Material 3 navigation, components, spacing, semantics, and Android back behavior over web-oriented patterns.
- Reject landing-page structures, horizontal-scroll storytelling, hover interactions, CSS/GSAP snippets, and desktop navigation patterns unless the user explicitly requests a web surface.
- For Chinese interfaces, prefer the Android system CJK font or a verified CJK family. Do not recommend a Latin-only Google Fonts pairing for Chinese body text.
- For map and navigation screens, prioritize outdoor contrast, glanceability, one-handed reach, 48dp touch targets, clear route-state colors, unobstructed map gestures, and reduced interaction while moving.
- Use generated palettes as a starting point, then map them to semantic Material 3 color roles and verify light/dark contrast.
- Read `references/pro-rules.md` before finalizing a native mobile design.
...
```bash
python3 "/mnt/c/Users/admin/.codex/skills/ui-ux-pro-max/scripts/search.py" "<product_type> <industry> <keywords>" --design-system [-p "Project Name"]
```
...
**Example:**
```bash
python3 "/mnt/c/Users/admin/.codex/skills/ui-ux-pro-max/scripts/search.py" "beauty spa wellness service" --design-system -p "Serenity Spa"
```
...
```bash
python3 "/mnt/c/Users/admin/.codex/skills/ui-ux-pro-max/scripts/search.py" "<query>" --design-system --persist -p "Project Name" --output-dir "<project-root>"
```
...
```bash
python3 "/mnt/c/Users/admin/.codex/skills/ui-ux-pro-max/scripts/search.py" "<query>" --design-system --variance <1-10> --motion <1-10> --density <1-10>
```
...
**Example:**
```bash
python3 "/mnt/c/Users/admin/.codex/skills/ui-ux-pro-max/scripts/search.py" "internal analytics dashboard" --design-system --variance 8 --motion 7 --density 8 -p "Ops Console"
```

### Step 3: Supplement with Detailed Searches (as needed)

```bash
python3 "/mnt/c/Users/admin/.codex/skills/ui-ux-pro-max/scripts/search.py" "<keyword>" --domain <domain> [-n <max_results>]
```
...
```bash
python3 "/mnt/c/Users/admin/.codex/skills/ui-ux-pro-max/scripts/search.py" "<keyword>" --stack <stack>
```
...
python3 "/mnt/c/Users/admin/.codex/skills/ui-ux-pro-max/scripts/search.py" "AI search tool modern minimal" --design-system -p "AI Search"

# Step 3: supplement
python3 "/mnt/c/Users/admin/.codex/skills/ui-ux-pro-max/scripts/search.py" "search loading animation" --domain ux

# Step 4: stack guidelines
python3 "/mnt/c/Users/admin/.codex/skills/ui-ux-pro-max/scripts/search.py" "suspense streaming bundle" --stack nextjs
```
